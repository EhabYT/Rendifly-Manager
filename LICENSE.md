...
Para solicitar autorización, utiliza el contacto oficial indicado en el [README](README.md#eb-manager-support).
...
For permission requests, use the official contact listed in the [README](README.md#eb-manager-support).
